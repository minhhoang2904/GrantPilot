...
class MongoPolicyRepository:
    def __init__(self, client=None) -> None:
        ...
        self.policies = database[config.MONGODB_POLICIES_COLLECTION]
        self.legal_units = database[config.MONGODB_LEGAL_UNITS_COLLECTION]
        self.documents = database[config.MONGODB_DOCUMENTS_COLLECTION]
    ...
    def get_policies(
        ...
        *,
        ...
        query: dict[str, Any] = {"is_current": {"$ne": False}}
